...
Flower::Flower(const Flower& other)
    :stem(new Shape(*(other.stem))),pistil(new Shape(*(other.pistil))),leaf(new Shape(*(other.leaf)))
{
}
...
void Flower::_copy(const Flower& other){
    stem = new Shape(*(other.stem));
    pistil = new Shape(*(other.pistil));
    leaf = new Shape(*(other.leaf));
}
