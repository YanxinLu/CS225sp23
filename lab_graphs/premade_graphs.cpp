...
Graph PremadeGraphs::createChinaMap(bool isWeighted)
{
    ...
    string labels[] = {"Beijing", "Shanghai", "Guangzhou", "Shenzhen",
                        "Chengdu", "Hangzhou", "Wuhan", "Nanjing",
                        "Changsha", "Qingdao", "Xianggang", "Xian"};
    ...
    g.insertEdge(vertices[0], vertices[11]);
    g.insertEdge(vertices[1], vertices[5]);
    g.insertEdge(vertices[1], vertices[7]);
    g.insertEdge(vertices[2], vertices[3]);
    g.insertEdge(vertices[2], vertices[4]);
    g.insertEdge(vertices[2], vertices[8]);
    g.insertEdge(vertices[2], vertices[10]);
    g.insertEdge(vertices[4], vertices[11]);
    g.insertEdge(vertices[5], vertices[7]);
    g.insertEdge(vertices[5], vertices[8]);
    g.insertEdge(vertices[6], vertices[11]);
    g.insertEdge(vertices[9], vertices[11]);

    if (isWeighted) {
        g.setEdgeWeight(vertices[0], vertices[7], 661);
        g.setEdgeWeight(vertices[0], vertices[9], 410);
        g.setEdgeWeight(vertices[0], vertices[11], 733);
        g.setEdgeWeight(vertices[1], vertices[5], 100);
        g.setEdgeWeight(vertices[1], vertices[7], 186);
        g.setEdgeWeight(vertices[2], vertices[3], 91);
        g.setEdgeWeight(vertices[2], vertices[4], 1031);
        g.setEdgeWeight(vertices[2], vertices[8], 416);
        g.setEdgeWeight(vertices[2], vertices[10],115);
        g.setEdgeWeight(vertices[4], vertices[11],442);
        g.setEdgeWeight(vertices[5], vertices[7], 170);
        g.setEdgeWeight(vertices[5], vertices[8], 608);
        g.setEdgeWeight(vertices[6], vertices[11], 454);
        g.setEdgeWeight(vertices[9], vertices[11], 733);
    }
